...
Judging from the heatmap above, the `2-4-injury`, `cyst-nematode`, `diaporthe-pod-&-stem-blight`, and `herbicide-injury` have many predictors that are always missing while `phytophtoria-rot` has some entries are missing but not all.


#### (c) Develop a strategy for handling missing data, either by eliminating predictors or imputation.

Given our heatmap from before, I would recommend removing the `2-4-d-injury`, `cyst-nematode`, `diaporthe-pod-&-stem-blight`, and `herbicide-injury` classes as there are too many nulls from the dataset.
